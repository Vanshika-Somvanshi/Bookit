      ...
      <div className="container">
        <div className="about-us-heading">
          ...
          <div className="aboutus-logo-container">
            ...
            <h1 className="aboutus-logo-text">BookIt</h1>
          </div>
        </div>
        <div className="about-us-body">
          <p>Welcome to BookIt,</p>
          <p>
            At BookIt, we are passionate about delivering the ultimate
          ...
          <p>
            Join us at BookIt and immerse yourself in the captivating world
